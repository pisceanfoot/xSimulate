...
namespace xSimulate.Web.Genration
{
    public class ConfigHelper
    {
        ...
        {
            string path = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Setting");
        ...
        public static string Create(string fileGeneratorXml)
        {
            if (string.IsNullOrEmpty(fileGeneratorXml))
            {
                return null;
            }

            FileGenerator fileGenerator = XmlSerializerHelper.DeSerializer<FileGenerator>(fileGeneratorXml);
